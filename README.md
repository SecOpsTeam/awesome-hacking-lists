...
- [RAT-Hodin-v1.0](https://github.com/Thibault-69/RAT-Hodin-v1.0) - Remote Administration Tool for Linux
...
- [BabySploit](https://github.com/M4cs/BabySploit) - BabySploit Beginner Pentesting Toolkit/Framework Written in Python
...
- [PoCBox](https://github.com/gh0stkey/PoCBox) - PoCBox - 漏洞测试验证辅助平台
- [ChineseDarkWebCrawler](https://github.com/C4o/ChineseDarkWebCrawler) - 中文暗网爬虫
- [TrackRay](https://github.com/iSafeBlue/TrackRay) - 溯光 (TrackRay) 3 插件式渗透测试框架（资产扫描|指纹识别|暴力破解|网页爬虫|端口扫描|漏洞扫描|AWVS|NMAP|Metasploit）
...
- [NewBie-Plan](https://github.com/553899811/NewBie-Plan) - Java 技术面试知识点总结
...
- [DmmVideoPreview](https://github.com/yhf7952/DmmVideoPreview) - AV短视频预览-源于dmm.co.jp。国内免帆解析预览视频，可进行多种筛选
...
- [ysfaka](https://github.com/assimon/ysfaka) - 云尚自动发卡
...
- [WeblogicR2](https://github.com/rabbitmask/WeblogicR2) - Weblogic批量检测工具，搭配配套过滤工具食用风味更佳
...
- [DeTTACT](https://github.com/rabobank-cdc/DeTTACT) - Detect Tactics, Techniques & Combat Threats
...
- [CTFCrackTools-V2](https://github.com/0Chencc/CTFCrackTools-V2) - CTFCrackToolsV2
...
- [WeblogicScan](https://github.com/rabbitmask/WeblogicScan) - Weblogic vulnerability one-click poc detection.
...
- [tool](https://github.com/spacesec/tool) - 渗透测试实用工具
...
- [awesome-algorithm](https://github.com/apachecn/awesome-algorithm) - Lisanaaa 小专栏
...
- [superl-url](https://github.com/super-l/superl-url) - 通知：Star到350，增加Bing(必应)！！！根据关键词，对搜索引擎内容检索结果的网址内容进行采集的一款轻量级软程序。  程序主要运用于安全渗透测试项目，以及批量评估各类CMS系统0DAY的影响程度，同时也是批量采集自己获取感兴趣的网站的一个小程序~~  可自动从搜索引擎采集相关网站的真实地址与标题等信息，可保存为文件，自动去除重复URL。同时，也可以自定义忽略多条域名等。
...
- [PwnBox](https://github.com/Corb3nik/PwnBox) - A lightweight VM for RE (fuzzing, symEx, exploiting etc) and wargaming tasks
...
- [Mob](https://github.com/zenghongtu/Mob) - Mob - 一个高颜值的喜马拉雅桌面客户端，支持 Mac、Win 和 Linux
...
- [vue-cli3.0-vueadmin](https://github.com/loveRandy/vue-cli3.0-vueadmin) - 基于vue-cli3.0+vue+elementUI+vuex+axios的网站后台模板
